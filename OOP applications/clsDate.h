...
public:
	...
	static clsDate IncreaseDateByOneYear(clsDate &Date)
	{
		...
		if (Date.GetMonth() == 2 && Date.GetDay() == 29 && !Date.isLeapYear(newYear))
		{
			Date.SetDay(28);
		}
	...
	clsDate IncreaseDateByOneDecade(clsDate &Date)
	{
		...
		return Date.IncreaseDateByXYears(10, Date);
	}
	...
	clsDate IncreaseDateByXDecades(short Decade, clsDate &Date)
	{
		...
		return Date.IncreaseDateByXYears(10 * Decade, Date);
	}
	...
	{
		// Period of 100 years
		return Date.IncreaseDateByXYears(100, Date);
	}
	...
	{
		return Date.IncreaseDateByXYears(1000, Date);
	}
	...
	{
		return Date.DecreaseDateByXYears(10, Date);
	}
	...
	static clsDate DecreaseDateByXDecades(short Decades, clsDate &Date)
	{
		...
		return Date.DecreaseDateByXYears(10 * Decades, Date);
	}
	...
	{
		return Date.DecreaseDateByXYears(100, Date);
	};
	...
	{
		return Date.DecreaseDateByXYears(1000, Date);
	}
	...
	{
		// Weekends are Sun,Mon,Tue,Wed and Thur   (That in Syria
